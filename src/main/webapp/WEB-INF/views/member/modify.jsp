                        ...
                        <div class="input-box justify-content-center">
                            <div class="row g-4 justify-content-center">
	                            ...
	                            <form method="post">
                                	...
                                	<div class="float-start m-2">
    	                          	...
    	                          	<div class="float-end col-10 mt-1">
        	                            <input type="text" class="form-control" id="name" placeholder="변경하실 이름을 입력해주세요" name="name" >
            	                    </div>
                	           	</div>
                                ...
                                <div class="col-10">
                                   ...
                                   <div class="float-end col-10 mt-1">
                                        <input type="text" class="form-control" id="phone" placeholder="변경하실 전화번호를 입력해주세요"name="phone" >
                                    </div>
                                </div>
                                <div class="col-10  mb-5">
                                    ...
                                    <div class="float-end col-10">
                                        <input type="text" class="form-control" id="email" placeholder="변경하실 이메일을 입력해주세요" name="email" >
                                    </div>
                                </div>
                                <div class="col-3 ">
